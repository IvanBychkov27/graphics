// https://www.rsdn.org/article/opengl/ogltut2.xml#E23AI
/*
Программа предназначена для демонстрации модели освещения OpenGL на примере простой сцена, состоящей из тора, конуса и шара.
Объектам назначаются разные материалы. В сцене присутствует точечный источник света.

 gcc main03.c -o main03 -lglut -lGL
    ./main03
*/
...
void display (void)
{
   ...
   glutSolidTorus (0.155, 0.55, 30, 30);
   glPopMatrix ();
